...
const Navbar = () => {
    ...
    return (
        <div className=' bg-white py-3 shadow-2xl z-50 '>
            <div className='w-full mx-auto flex justify-evenly items-center relative'>
                {/* Logo section */}
                ...
                {/* Menu section */}
                <div className='w-[50%] h-9.5 border-2 border-gray-400 rounded-lg overflow-hidden'>
                    <Link to='/products'>
                        <input type="search"
                            placeholder='Search ...'
                            value={search}
                ...
                <div className=' w-[20%] relative flex gap-7 items-center justify-center'>
