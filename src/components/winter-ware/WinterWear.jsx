...
const WinterWear = () => {
  ...
  return (
    <section className='mt-4' >
      <div className="max-w-6xl bg-gray-100 mx-auto px-4 py-8 rounded-md">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 place-items-center lg:grid-cols-4 gap-4">
          {data.slice(88, 92).map((product) => (
